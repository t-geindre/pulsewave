...
func NewTree(presets []string) Node {
	tree := NewNode("",
		...
		NewNode("Modulation V2",
			...
			NewNode("Velocity"),
			NewLfoNode("LFO 01", 255, preset.Lfo0Shape, preset.Lfo0rate, preset.Lfo0Phase, 255, 0, 20, 1, formatHertz),
			NewLfoNode("LFO 02", 255, preset.Lfo1Shape, preset.Lfo1rate, preset.Lfo1Phase, 255, 0, 20, 1, formatHertz),
			NewLfoNode("LFO 03", 255, preset.Lfo2Shape, preset.Lfo2rate, preset.Lfo2Phase, 255, 0, 20, 1, formatHertz),
		...
		NewNode("Modulation",
			...
			NewNode("Cutoff",
				NewLfoNode("LFO", preset.LpfLfoOnOff, preset.LpfLfoShape, preset.LpfLfoFreq, preset.LpfLfoPhase, preset.LpfLfoAmount, 1, 20000, 1, formatHertz),
			...
			NewNode("Pitch",
				NewLfoNode("LFO", preset.PitchLfoOnOff, preset.PitchLfoShape, preset.PitchLfoFreq, preset.PitchLfoPhase, preset.PitchLfoAmount, 1, 1000, .01, formatSemiTon),
